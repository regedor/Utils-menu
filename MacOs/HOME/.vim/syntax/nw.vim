...
" Place in: /usr/share/vim/vim72/syntax/nw.vim
" or ~/.vim/syntax/nw.vim
...
syntax include @nowebIncludedPerl syntax/perl.vim
...
syntax region nowebCode start=/<<[^ ]\| *.*\.\(pl\|perl\)>>=/ end=/^@ \|^@$/me=e-3 contains=@nowebIncludedPerl, nowebName containedin=tex.*Zone
